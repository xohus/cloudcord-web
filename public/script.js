document.addEventListener('DOMContentLoaded', () => {
    ...
    if (navContent) {
        ...
        toggleBtn.addEventListener('click', (e) => {
            ...
            toggleBtn.setAttribute('aria-expanded', toggleBtn.classList.contains('active') ? 'true' : 'false');
        });
