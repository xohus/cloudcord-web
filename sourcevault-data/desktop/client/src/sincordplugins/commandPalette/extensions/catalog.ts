...
export const EXTENSIONS_CATALOG: ExtensionDefinition[] = [
    ...
    },
    {
        ...
        commandDescription: "Run the extension command from this detail page.",
        sourcePath: "src/sincordplugins/randomVoice",
        tags: [TAG_PLUGINS, TAG_UTILITY],
    ...
    },
    {
        ...
        sourcePath: "src/sincordplugins/scheduledMessages",
        tags: [TAG_PLUGINS, TAG_UTILITY],
    ...
    },
    {
        ...
        sourcePath: "src/sincordplugins/themeLibrary",
        tags: [TAG_PLUGINS, TAG_UTILITY],
...
export const SINCORD_REPOSITORY_BLOB_BASE_URL = "https://github.com/Sincord/Sincord/blob/main";
...
export function toRepositoryBlobUrl(path: string): string {
    ...
    return `${SINCORD_REPOSITORY_BLOB_BASE_URL}/${normalizedPath}`;
}
