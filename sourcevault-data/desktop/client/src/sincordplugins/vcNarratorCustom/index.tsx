...
export default definePlugin({
    ...
    authors: [Devs.Ven, Devs.Nyako, SincordDevs.Loukios, SincordDevs.examplegit, SincordDevs.qdnx],
    settings,
    contextMenus: {
    ...
    settingsAboutComponent({ tempSettings: s }: { tempSettings?: any; }) {
        ...
        const authorUser = UserStore.getUser(String(SincordDevs.examplegit.id));
