...
import { LyricsData, Provider } from "@sincordplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@sincordplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Sincord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
