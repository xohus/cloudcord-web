...
import { providers } from "@sincordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@sincordplugins/musicControls/spotify/lyrics/providers/store";
