...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@sincordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@sincordplugins/musicControls/spotify/SpotifyStore";
