...
export default definePlugin({
    ...
    tags: ["Fun"],
    authors: [SincordDevs.SomeAspy, Devs.thororen],
    dependencies: ["AudioPlayerAPI"],
    settings,
    start() {
        croissant = createAudioPlayer("https://github.com/Sincord/Sinbored/raw/main/sounds/sinissant/croissant.mp3", { persistent: true });
