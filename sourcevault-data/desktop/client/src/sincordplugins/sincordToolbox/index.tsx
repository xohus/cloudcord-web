        ...
        >
            {(_, { isShown }) => (
                <HeaderBarButton
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Sincord Toolbox"}
                    icon={Icon}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("SincordToolbox", "VencordToolbox");
export default definePlugin({
    name: "SincordToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses Sincord quick actions",
