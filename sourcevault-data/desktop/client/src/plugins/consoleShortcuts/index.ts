...
const switchBranch = (branch: string) => () => {
    if (!IS_VESKTOP && !IS_EQUIBOP) throw new Error("This function only works on vesktop and sinbop.");

    const target = IS_VESKTOP ? Vesktop : Sinbop;
...
function makeShortcuts() {
    ...
    return {
        ...
        switchBranch,
        ...IS_EQUIBOP ? {
            sinbopStable: switchBranch("stable"),
            sinbopCanary: switchBranch("canary"),
            sinbopPtb: switchBranch("ptb"),
        } : {},
    };
}
