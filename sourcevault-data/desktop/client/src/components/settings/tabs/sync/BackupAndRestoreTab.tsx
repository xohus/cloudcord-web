    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom20}>
                Import and export your CloudCord settings as a local JSON file. This allows you to transfer settings to another device, or recover them after reinstalling CloudCord or Discord.
            </Paragraph>
