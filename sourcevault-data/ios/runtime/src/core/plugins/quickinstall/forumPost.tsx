...
import { HTTP_REGEX_MULTI, CLOUDCORD_DISCORD_SERVER_ID, CLOUDCORD_PLUGINS_CHANNEL_ID, CLOUDCORD_THEMES_CHANNEL_ID, VD_DISCORD_SERVER_ID, VD_PLUGINS_CHANNEL_ID, VD_PROXY_PREFIX, VD_THEMES_CHANNEL_ID } from "@lib/utils/constants";
...
function useExtractThreadContent(thread: any, _firstMessage = null, actionSheet = false): ([PostType, string]) | void {
    if (thread.guild_id !== CLOUDCORD_DISCORD_SERVER_ID) return;
